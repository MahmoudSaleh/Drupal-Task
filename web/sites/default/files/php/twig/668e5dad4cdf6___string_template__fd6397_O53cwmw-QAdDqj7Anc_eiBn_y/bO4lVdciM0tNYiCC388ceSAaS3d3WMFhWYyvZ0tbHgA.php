...
/* __string_template__fd639725a8f95ea10170823481c3a18c */
class __TwigTemplate_939f7326f23ff47b6bdd53f1cc925305 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<p style=\"box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
                                             ...
                                             text-align: right !important;  direction: rtl !important;\">
\t\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t\tتهديكم اللجنة المنظمة لمؤتمر العمل البلدي المستدام 2024 أطيب التحيات، وعليه تود إبلاغكم باستلام الملخص البحثي الخاص بكم ورقمه  
\t\t\t\t\t\t\t\t\t\t\t\t\t<span style=\"direction: ltr !important; color: gary; text-decoration: underline; \">
\t\t\t\t\t\t\t\t\t\t\t\t\t\tS";
        // line 106
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["data"] ?? null), "lmhwr", [], "any", false, false, true, 106), 106, $this->source), "html", null, true);
        yield "-";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["serial"] ?? null), 106, $this->source), "html", null, true);
        yield "
\t\t\t\t\t\t\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t\t\t\t\t\tوسوف يتم إفادتكم بعد مراجعته من قبل اللجنة العلمية لمؤتمر. 
...
\t\t\t\t\t\t\t\t\t\t\t\t\tنأمل ارفاق رقم البحث في أي مراجعات مستقبلية
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["data", "serial"]);        return; yield '';
    }
    ...
    {
        return "__string_template__fd639725a8f95ea10170823481c3a18c";
    }
    ...
    {
        return array (  150 => 106,  132 => 91,  40 => 1,);
    }
