...
/* __string_template__a1bf4ed9093cf14e6de5942c580b9dd7 */
class __TwigTemplate_8932a3bfef6ae47e1f8acdc635a2a76b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<p style=\"box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
                                             ...
                                             text-align: right !important;  direction: rtl !important;\">
\t\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t\tتهديكم اللجنة المنظمة لمؤتمر العمل البلدي المستدام 2024 أطيب التحيات، وعليه تود إبلاغكم باستلام طلب تسجيلكم في المعرض وسوف يتم التواصل معاك بأقرب وقت.
...
";
    ...
    {
        return "__string_template__a1bf4ed9093cf14e6de5942c580b9dd7";
    }
