...
class __TwigTemplate_e182090a4ec50ed7bffa908d3e7109ea extends Template
{
    private $source;
    private $macros = [];
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("{% line 8 %}{% set config_translation_link_text %}{% trans %}Configuration translation{% endtrans %}{% endset %}
...
</ol>", "@help_topics/config_translation.overview.html.twig", "/home/ccgforum/public_html/web/core/modules/config_translation/help_topics/config_translation.overview.html.twig");
    }
