...
class __TwigTemplate_9d18535f99bab098cf88e8ccb1b525bb extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
      ...
      ";
            ...
            if (($context["setting_logo"] ?? null)) {
                // line 21
                yield "         <img class=\"logo-theme\" src=\"";
...
{% block content %}
  {% if site_logo %}
    <a href=\"{{ path('<front>') }}\" title=\"{{ 'Home'|t }}\" rel=\"home\" class=\"site-branding-logo\">
      {% if setting_logo %}
         <img class=\"logo-theme\" src=\"{{ site_logo|replace({'.svg': '.png'}) }}\" alt=\"{{ 'Home'|t }}\" />
         <img class=\"logo-theme logo-white d-none\" src=\"{{ site_logo|replace({'logo.svg': 'logo-white.png'}) }}\" alt=\"{{ 'Home'|t }}\" />
      {% else %}  
  ...
  {% endif %}
{% endblock %}
", "themes/gavias_edupia/templates/block/block--system-branding-block.html.twig", "/home/ccgforum/public_html/web/themes/gavias_edupia/templates/block/block--system-branding-block.html.twig");
    }
